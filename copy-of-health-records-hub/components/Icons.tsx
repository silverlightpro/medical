...
export const FileTextIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className || "w-6 h-6"}>
    ...
    <path d="M12.971 1.816A5.23 5.23 0 0114.25 1.5c.403 0 .78.067 1.128.188V5.25h3.372c.121.348.188.725.188 1.128h-1.875a3.75 3.75 0 01-3.75-3.75V1.816z" />
  </svg>
);
...
export const ArrowTrendingUpIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18L9 11.25l4.306 4.307a11.95 11.95 0 015.814-5.519l2.74-1.22m0 0l-3.75-.625m3.75.625V16.5" />
    </svg>
);
...
export const BeakerIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 6.087c0-1.731.878-3.252 2.25-4.012A48.204 48.204 0 0112 2.25c-2.433 0-4.755.52-6.938 1.455 1.372.76 2.25 2.281 2.25 4.012v.223A48.09 48.09 0 0112 6.5c2.433 0 4.755-.52 6.938-1.455v-.223z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 6.087v8.913a.75.75 0 01-.41.673l-2.083.992a48.217 48.217 0 01-4.514 0l-2.083-.992a.75.75 0 01-.41-.673V6.087m11.25 0c.263.124.51.26.75.405m-12 0c-.263.124-.51.26-.75.405m10.5 0a48.07 48.07 0 01-10.5 0" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 15.75c0 1.383 1.117 2.5 2.5 2.5h11.5c1.383 0 2.5-1.117 2.5-2.5v-1.5A1.5 1.5 0 0018.75 13H5.25a1.5 1.5 0 00-1.5 1.25v1.5z" />
  </svg>
);
